...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get appConfigSubtitle =>
      'اختر نسقك ولغتك المفضلة للبدء بتجربة مريحة ومخصصة تناسب أسلوبك.';
  ...
  @override
  String get emailMinLength => 'يجب أن يكون البريد الإلكتروني 3 أحرف على الأقل';
  ...
  String get confirmPasswordCannotBeEmpty =>
      'تأكيد كلمة المرور لا يمكن أن يكون فارغاً';
